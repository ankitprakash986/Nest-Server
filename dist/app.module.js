...
AppModule = __decorate([
    (0, common_1.Module)({
        imports: [mongoose_1.MongooseModule.forRoot('mongodb://127.0.0.1:27017/'), database_module_1.DatabaseModule, mongoose_1.MongooseModule.forFeature([{ name: 'Cat', schema: category_1.CategorySchema }]),
            mongoose_1.MongooseModule.forFeature([{ name: 'UserDetail', schema: user_1.UserSchema }])],
